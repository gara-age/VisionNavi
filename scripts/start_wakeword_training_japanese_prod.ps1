...
function Start-BackgroundSerialQueue {
  ...
  $queueLogPath = Join-Path $logDir "wakeword_training_japanese_prod.log"
  $queueErrPath = Join-Path $logDir "wakeword_training_japanese_prod.error.log"
  ...
  Write-Host "Started Japanese production wakeword training queue."
...
Write-Host ""
Write-Host "Japanese production wakeword training pipelines completed."
